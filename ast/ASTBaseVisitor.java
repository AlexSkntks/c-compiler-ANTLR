...
public abstract class ASTBaseVisitor<T> {
    ...
    protected abstract T visitTranslationUnit(AST node);

    //externalDeclaration : functionDefinition | declaration |';'
	 
    protected abstract T visitExternalDeclaration(CParser.ExternalDeclarationContext ctx);


	
    protected abstract T visitCompoundStatement(CParser.CompoundStatementContext ctx);

    protected abstract T visitDeclaration(CParser.DeclarationContext ctx);

    protected abstract T visitAssignmentExpression(CParser.AssignmentExpressionContext ctx);

    //initDeclaratorList : initDeclarator (',' initDeclarator)*
	
    protected abstract T visitInitDeclaratorList(CParser.InitDeclaratorListContext ctx);
	
    protected abstract T visitInitDeclarator(CParser.InitDeclaratorContext ctx);
     
    protected abstract T visitDeclarationSpecifiers(CParser.DeclarationSpecifiersContext ctx);
	
    protected abstract T visitAdditiveExpression(CParser.AdditiveExpressionContext ctx);
	
    protected abstract T visitMultiplicativeExpression(CParser.MultiplicativeExpressionContext ctx);

    
    protected abstract T visitPostfixExpression(CParser.PostfixExpressionContext ctx);
	
    protected abstract T visitPrimaryExpression(CParser.PrimaryExpressionContext ctx);
	
    protected abstract T visitTypedefName(CParser.TypedefNameContext ctx);
    
    protected abstract T visitFunctionDefinition(CParser.FunctionDefinitionContext ctx);
	 
    protected abstract T visitBlockItemList(CParser.BlockItemListContext ctx);
	
    protected abstract T visitExpressionStatement(CParser.ExpressionStatementContext ctx);
     
    protected abstract T visitStatement(CParser.StatementContext ctx);
    protected abstract T visitJumpStatement(CParser.JumpStatementContext ctx);
    
    protected abstract T visitTypeSpecifier(CParser.TypeSpecifierContext ctx);
	
    protected abstract T visitFuncDeclaration1(CParser.FuncDeclaration1Context ctx);
    
    protected abstract T visitFuncDeclaration2(CParser.FuncDeclaration2Context ctx);
  
 
	
    protected abstract T visitFuncName(CParser.FuncNameContext ctx);
	
    protected abstract T visitParameterList(CParser.ParameterListContext ctx);
    
    protected abstract T visitParameterDeclaration(CParser.ParameterDeclarationContext ctx);
