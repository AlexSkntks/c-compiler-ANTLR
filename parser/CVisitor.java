...
public interface CVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDeclarationVar(CParser.DeclarationVarContext ctx);
	/**
	 * Visit a parse tree produced by the {@code declarationAssert}
	 * labeled alternative in {@link CParser#declaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclarationAssert(CParser.DeclarationAssertContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code naoInteressa6}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa6(CParser.NaoInteressa6Context ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFuncName(CParser.FuncNameContext ctx);
	/**
	 * Visit a parse tree produced by the {@code naoInteressa4}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa4(CParser.NaoInteressa4Context ctx);
	/**
	 * Visit a parse tree produced by the {@code naoInteressa5}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa5(CParser.NaoInteressa5Context ctx);
	/**
	 * Visit a parse tree produced by the {@code funcDeclaration1}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncDeclaration1(CParser.FuncDeclaration1Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code naoInteressa2}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa2(CParser.NaoInteressa2Context ctx);
	/**
	 * Visit a parse tree produced by the {@code funcDeclaration2}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFuncDeclaration2(CParser.FuncDeclaration2Context ctx);
	/**
	 * Visit a parse tree produced by the {@code naoInteressa3}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa3(CParser.NaoInteressa3Context ctx);
	/**
	 * Visit a parse tree produced by the {@code naoInteressa1}
	 * labeled alternative in {@link CParser#directDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNaoInteressa1(CParser.NaoInteressa1Context ctx);
	/**
